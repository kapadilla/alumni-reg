...
const formSchema = z
  .object({
    ...
    // Membership
    membershipType: z.string().min(1, "This field is required"),
  ...
  .refine(
    (data) => {
      ...
      if (data.paymentMethod === "gcash") {
        return !!data.gcashReferenceNumber && !!data.gcashProofOfPayment;
      }
      if (data.paymentMethod === "bank") {
        return (
          ...
          !!data.bankProofOfPayment
        );
      }
      if (data.paymentMethod === "cash") {
        return !!data.cashPaymentDate && !!data.cashReceivedBy;
      }
      return true;
    },
    {
